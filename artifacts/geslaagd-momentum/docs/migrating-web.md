# Migrating web UI to Geslaagd Momentum

Read `artifacts/geslaagd-momentum/docs/AGENTS.md` and
`artifacts/geslaagd-momentum/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/geslaagd-momentum/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/geslaagd-momentum/lib/utils`
- `@/hooks/use-toast` → `@workspace/geslaagd-momentum/hooks/use-toast`
