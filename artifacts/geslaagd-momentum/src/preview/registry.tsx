...
export const DESIGN_SYSTEM = {
  title: 'Geslaagd Momentum',
  description:
    'Een gefocust designsysteem dat leersonzekerheid verandert in één duidelijke, geloofwaardige volgende stap.',
} as const;

export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overzicht',
  description: 'De visuele uitgangspunten en het gedrag achter focused momentum.',
  Page: OverviewPage,
};
...
export const NAV_GROUPS: NavGroup[] = [
    ...
    entries: [
      {
        id: 'brand-identity',
        name: 'Identiteit',
        description: 'Woordmerk, merkgedrag en de stem van geslaagd.app.',
        Page: BrandPage,
      },
    ],
  },
    ...
    entries: [
      {
        ...
        name: 'Taal en staten',
        description: 'Korte, actieve Nederlandse copy voor grip, vertrouwen en leeruitkomst.',
    ...
    entries: [
      {
        id: 'motion-rules',
        name: 'Beweging',
        description: 'Korte, rustige feedback die focus ondersteunt en reduced motion respecteert.',
        Page: MotionPage,
      },
    ],
  },
  {
    ...
    entries: [
      {
        id: 'applied-learning-flow',
        name: 'Leerflow',
        description: 'Coachprompt, bronkaart, selectie, progressie, auth en beheersignalen in samenhang.',
